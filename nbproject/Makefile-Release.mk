...
${OBJECTDIR}/Stackful/Stackful.o: Stackful/Stackful.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Stackful/Stackful.o Stackful/Stackful.cpp

${OBJECTDIR}/Stackful/src/sfatoms.o: Stackful/src/sfatoms.cpp
	${MKDIR} -p ${OBJECTDIR}/Stackful/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Stackful/src/sfatoms.o Stackful/src/sfatoms.cpp
...
${OBJECTDIR}/Stackful/src/sfinterp.o: Stackful/src/sfinterp.cpp
	${MKDIR} -p ${OBJECTDIR}/Stackful/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Stackful/src/sfinterp.o Stackful/src/sfinterp.cpp

${OBJECTDIR}/Stackful/src/sfparser.o: Stackful/src/sfparser.cpp
	${MKDIR} -p ${OBJECTDIR}/Stackful/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Stackful/src/sfparser.o Stackful/src/sfparser.cpp
...
${OBJECTDIR}/Stackful/src/sftypes.o: Stackful/src/sftypes.cpp
	${MKDIR} -p ${OBJECTDIR}/Stackful/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Stackful/src/sftypes.o Stackful/src/sftypes.cpp
